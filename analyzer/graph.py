...
=======
    ...
    friends all ship 1.21.1 builds that still carry `[1.21,1.21.1)` from the 1.21
    MDK template, and those packs run. What actually pins the Minecraft version is
...
=======
            ...
            g.warnings.append(
                {
                    "level": "info" if stale else "error",
                    "code": "platform_unsatisfied",
                    "slug": req.slug,
                    "message": f"needs {req.mod_id} {req.version_range}, pack has {have}"
